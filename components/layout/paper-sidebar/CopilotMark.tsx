...
/** Copilot mark from Paper (48×48 gradient) */
    ...
    >
      <defs>
        ...
        <radialGradient
          ...
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="rotate(51.84 -28.201 27.85) scale(15.991 15.512)"
        >
        ...
        <radialGradient
          ...
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="rotate(109.274 16.301 20.802) scale(38.387 45.987)"
        >
          <stop offset=".066" stopColor="#8C48FF" />
          <stop offset=".5" stopColor="#F2598A" />
          <stop offset=".896" stopColor="#FFB152" />
        </radialGradient>
        <linearGradient id={`${id}-g3`} x1="12.5" y1="7.5" x2="14.788" y2="33.975" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id={`${id}-g4`} x1="14.5" y1="4" x2="15.75" y2="32.885" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3DCBFF" />
          <stop offset=".247" stopColor="#0588F7" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={`${id}-g5`} x1="42.586" y1="13.346" x2="42.569" y2="21.215" gradientUnits="userSpaceOnUse">
